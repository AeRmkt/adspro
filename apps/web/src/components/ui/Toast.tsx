...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action ref={ref} className={cn('shrink-0 rounded-md border border-transparent bg-secondary px-3 py-1 text-sm font-medium hover:bg-secondary/80', className)} {...props} />
))
